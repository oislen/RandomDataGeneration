...
fpath_llama_firstnames = os.path.join(subdir_generator, 'ref', 'llama_firstnames.csv')
fpath_llama_lastnames = os.path.join(subdir_generator, 'ref', 'llama_lastnames.csv')

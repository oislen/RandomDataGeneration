...
sub_cols = ['userid', 'transaction_week', 'successful_size',  'successful_sum', 'customer_value_score_cumsum']
...
total_value_data = high_value_data.agg(agg_dict).rename('total').to_frame().T
high_value_data = pd.concat(objs=[high_value_data, total_value_data], axis=0)
high_value_data
```

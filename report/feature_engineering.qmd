...
```{python}
data['transaction_error_code'].value_counts()/data.shape[0]*100
base_feat_data['E901_size'].value_counts()#/base_feat_data[['successful_size', 'pending_size', 'rejected_size']].sum().sum()
```
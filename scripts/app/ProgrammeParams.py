...
class ProgrammeParams():
    ...
    def __init__(self, factor = 1, randomseed = None, n_users = 1372, n_applications = 16472, n_device_types = 53, registration_start_date = '2020-01-01', registration_end_date = '2021-12-31', transaction_start_date = '2021-01-01', transaction_end_date = '2021-12-31'):

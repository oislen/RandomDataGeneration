...
class Test_Card(unittest.TestCase):
    ...
    def test_type(self):
        ...
        self.assertEqual(
            type(self.obs_card_hashes_shared_props_dict),
            type(self.exp_card_hashes_shared_props_dict),
        )
    ...
    def test_len(self):
        ...
        self.assertEqual(
            len(self.obs_card_hashes_shared_props_dict),
            len(self.exp_card_hashes_shared_props_dict),
        )
    ...
    def test_keys(self):
        ...
        self.assertEqual(
            list(self.obs_card_hashes_shared_props_dict.keys()),
            list(self.exp_card_hashes_shared_props_dict.keys()),
        )
    ...
    def test_values(self):
        ...
        self.assertEqual(
            list(self.obs_card_hashes_shared_props_dict.values()),
            list(self.exp_card_hashes_shared_props_dict.values()),
        )
    ...
    def test_object(self):
        ...
        self.assertEqual(
            self.obs_card_hashes_shared_props_dict,
            self.exp_card_hashes_shared_props_dict,
        )

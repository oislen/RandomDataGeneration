...
exp_id_dict = {"6374692674377254": 4, "1751409580926382": 5, "4264861381989413": 2, "6720317315593519": 10}
exp_hash_dict = {'o68n07nag7yyw4r6': 1, '87bxwmnylqy0yd20': 3, '4pdq8eepcvv3tmes': 2, 'zcv6lr15rrjtarow': 1}
...
class Test_gen_idhash_cnt_dict(unittest.TestCase):
    ...
    def test_keys(self):
        self.assertEqual(
            list(self.obs_id_dict.keys()), list(self.exp_id_dict.keys())
        )
        self.assertEqual(
